...
ADMIN_OVERRIDE_MAX_ACTIVITIES = env_int("ADMIN_OVERRIDE_MAX_ACTIVITIES", 3000)
STRAVA_RESUME_CURSOR_MAX_AGE_HOURS = env_int("STRAVA_RESUME_CURSOR_MAX_AGE_HOURS", 72)
