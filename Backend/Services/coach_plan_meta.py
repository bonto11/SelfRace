...
def service_build_active_plan_block_for_analysis(user_id: int) -> Dict[str, Any]:
    """
    ...
    """
    row = db_get_active_plan_meta_for_user(user_id=user_id)
    if not row:
        return {
    ...
    # názvy prispôsobené tvojmu coach_plan_meta
