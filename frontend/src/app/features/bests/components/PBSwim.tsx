...
export default function PBSwim() {
  ...
  const previewText = useMemo(() => {
    const favLabel = distanceLabel(favoriteM, "swim");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload: any = {
        // 🐛 FIX: bolo "swimming", ale fetch/delete používajú "swim" —
        // po uložení sa PB po refreshi nezobrazilo (iný sport string v DB).
        sport: "swim",
        distance_m: m,
        ...(Number.isFinite(sec)
          ? { time_sec: sec }
