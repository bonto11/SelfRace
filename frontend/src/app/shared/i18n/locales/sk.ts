export const sk = {
  ...
  prefs: {
    ...
    sections: {
      ...
      injuriesSection: {
        ...
        noInjuries: "Žiadne aktívne zranenia",
        areaLabel: "Partia (Miesto)",
        typeLabel: "Druh bolesti",
        severityLabel: "Vážnosť bolesti (1-10)",
        severityScale: "1 = mierna, 10 = extrémna",
        noteLabel: "Detaily (Poznámka pre AI)",
        notePlaceholder: "Napr. bolí to iba pri behoch z kopca...",
        addBtn: "+ Pridať zranenie",
        removeBtn: "Odstrániť",
        severityInfo: "Vážnosť: {{severity}}/10",
        severityLevels: {
          mild: "Mierna bolesť (neobmedzuje tréning, ale cítim to).",
          moderate: "Stredná bolesť (obmedzuje intenzitu a dĺžku).",
          critical: "Silná bolesť (vyžaduje oddych / lekára).",
        },
        areas: {
          foot: "Chodidlo",
          ankle: "Členok",
        ...
        hints: {
          foot: "Kde presne? Päta, klenba, prsty alebo plantárna fascia?",
          ankle: "Ide o podvrtnutie, vonkajší/vnútorný členok alebo stabilitu?",
          achilles:
            "Bolesť priamo na šľache, pri úpone na pätu alebo vyššie k lýtku?",
          shin: "Holená kosť zpredu (okostica) alebo bolesť na vnútornej hrane?",
          calf: "Ide o natiahnutý sval, kŕče alebo bolesť hlboko v lýtku?",
          knee: "Bolesť pod jabĺčkom, na vonkajšej strane (IT band) alebo vo vnútri kĺbu?",
          quad: "Bolesť na prednej strane stehna (kvadriceps) alebo bližšie k slabinám?",
          hamstring:
            "Natiahnutie vzadu na stehne alebo bolesť vysoko tesne pod zadkom?",
          glute:
            "Hlboká bolesť v zadku (piriformis), vystreľuje do nohy, alebo svalovka?",
          hip: "Bolesť v bedrovom kĺbe z boku (burza) alebo vzadu?",
          psoas:
            "Bolesť hlboko v panve, pri dvíhaní kolena, alebo vyžaruje do chrbta?",
          groin:
            "Natiahnutý sval na vnútornej strane stehna (aduktor), alebo bolesť v triesle?",
          abdomen:
            "Bolí to na povrchu (brušné svaly, pruh) alebo skôr vo vnútri (pichanie v boku)?",
          back: "Kríže (spodný chrbát), stred chrbta alebo medzi lopatkami?",
          neck: "Stuhnutá krčná chrbtica alebo bolesť vystreľujúca do ramena?",
          shoulder: "Bolesť pri dvíhaní ruky, v rotácii alebo v pokoji?",
          arm_wrist:
            "Ide o zápästie, lakeť alebo predlaktie? (Časté pri bicyklovaní).",
          other:
            "Prosím, špecifikujte presné miesto a prejav bolesti do poznámky.",
        },
      },
      ...
      thresholdsSection: {
        ...
        sportLabel: "Šport",
        typeLabel: "Typ prahu",
        hrLabel: "Prahový tep [údery/min]",
        paceLabel: "Prahové tempo [min/km]",
        powerLabel: "Prahový výkon [W]",
      ...
      zonesSection: {
        ...
        HRmax: "Maximálny ST [údery/min]",
        LTHR: "Lactate threshold HR [údery/min]",
        ...
        zonesLabel: "Zóny srdcového tepu [údery/min]",
        lockedTooltip:
  ...
  estTopPaces: {
    title: "Vývoj Predikcií",
    widget: {
      title: "Odhadované preteky",
      tooltip: [
        "Odhadované preteky ti ukazujú tvoj aktuálny potenciál – na aký čas máš momentálne natrénované.",
        "",
        "Prečo to existuje?",
        "• Pomáha ti to nastaviť si reálne očakávania a pretekové tempo bez toho, aby si musel ísť každý týždeň testovať svoje maximum.",
        "• Zabraňuje to prepáleniu štartu, čo je najčastejšia chyba na pretekoch.",
        "",
        "Ako sa to počíta?",
        "• AI analyzuje tvoje najťažšie tréningy, vývoj tvojho laktátového prahu (LTHR) a aeróbnej kapacity.",
        "• Čím viac dát o tebe aplikácia má (hlavne z ťažkých intervalov a tempových behov), tým je odhad presnejší.",
        "",
        "Dôležité (realita):",
        "• Tieto časy predpokladajú ideálne podmienky: rovinatá trať, dobré počasie a plne oddýchnuté telo (tapering).",
        "",
        "Tip:",
        "• Neber tieto čísla ako garantovaný výsledok. Ber ich ako kompas na to, akým tempom by si mal do pretekov odštartovať.",
      ].join("\n"),
    },
  },
  zonesHR: {
    ...
    widget: {
      title: "Tepové zóny",
      tooltip: [
        "Tepové zóny sú tvoje osobné limity srdcového tepu (HR) pre 5 rôznych stupňov námahy.",
        "",
        "Prečo to existuje?",
        "• Najčastejšia chyba je behať „všetko rovnako rýchlo“. Zóny ti dávajú mantinely, aby si bežal pomaly, keď máš budovať vytrvalosť, a rýchlo, keď máš budovať rýchlosť.",
        "",
        "Ako čítať zóny?",
        "• Z1 / Z2 (Regenerácia a Vytrvalosť): Základný kameň. Malo by tu prebiehať 80 % tvojho tréningu. Je to tempo, pri ktorom dokážeš konverzovať.",
        "• Z3 (Tempo): Stredne ťažká námaha. Beh, ktorý vyžaduje sústredenie.",
        "• Z4 (Prahový beh): Ťažká námaha tesne pod tvojím limitom (LTHR). Tu telo bojuje s laktátom.",
        "• Z5 (Maximum): Šprinty a závery pretekov. Vydržíš tu len krátko.",
        "",
        "Dôležité (realita):",
        "• Zóny nie sú statické. Ako sa zlepšuje tvoja kondícia, AI tvoje hranice tepu automaticky posúva.",
        "",
        "Tip:",
        "• Ak si začiatočník, ego nechaj doma a striktne si stráž Zónu 2. Spočiatku to môže znamenať aj striedanie behu s chôdzou. Oplatí sa to.",
      ].join("\n"),
    },
  },
  zonesPaces: {
    title: "Vývoj Zónových Temp",
    widget: {
      title: "Tempá v zónach",
      tooltip: [
        "Zónové tempá ti ukazujú odhadovanú rýchlosť, akou by si mal bežať, aby si sa udržal v konkrétnej tepovej zóne.",
        "",
        "Prečo to existuje?",
        "• Srdcový tep reaguje na záťaž s oneskorením. Kým ti tep stúpne do správnej zóny, môžeš prepáliť tempo.",
        "• Tep navyše veľmi ovplyvňuje vonkajšia teplota, stres, káva alebo únava. Tempo je matematicky presnejšie.",
        "",
        "Ako to využiť v praxi?",
        "• Keď máš v pláne ľahký beh v Z2 a tvoje Z2 tempo je napr. 6:00/km, nesnaž sa bežať 5:30/km len preto, že sa dnes cítiš skvele.",
        "• Ideálne je kombinovať obe metriky: tempo ťa drží na uzde na rovine, tep ťa chráni pred preťažením v kopcoch.",
        "",
        "Dôležité (realita):",
        "• Tieto tempá platia výlučne pre rovinatý terén s pevným povrchom.",
        "",
        "Tip:",
        "• Pri behoch do kopca alebo v silnom protivetre tempá úplne ignoruj a riaď sa výhradne srdcovým tepom alebo vlastným pocitom (RPE).",
      ].join("\n"),
    },
  },
  coachAthleteState: {
    ...
    widget: {
      ...
      tooltip: [
        ...
        "",
        "Tip:",
        "• Keď je únava alebo riziko zranenia „high“, nerieš to panikou. Rieš to kontrastom: 1–2 veľmi ľahké dni, znížiť monotónnosť, pridať spánok a jedlo.",
      ].join("\n"),
  ...
  coachPrefs: {
    widget: {
      ...
      tooltip: [
        ...
        "",
        "Čo tu typicky spadá?",
        "• Cieľ (goal) – čo je hlavná priorita (napr. 5 km výkon, vytrvalosť, kopce, Spartan…).",
        "• Týždne – na koľko týždňov dopredu má byť plán vygenerovaný.",
        "• Športy – ktoré športy má coach brať do úvahy (hlavný šport + doplnkové).",
        "",
        "Prečo je to dôležité?",
        "• Ak je cieľ nejasný alebo nesedí, plán bude „správne“ vypočítaný, ale pre zlý cieľ.",
  ...
  settings: {
    ...
    prefs: {
      ...
      timezones: {
        ...
        "Asia/Karachi": "(UTC+05:00) Karáči",
        "Asia/Kolkata": "(UTC+05:30) India (Kalkata)",
        "Asia/Bangkok": "(UTC+07:00) Bangkok",
        "Asia/Shanghai": "(UTC+08:00) Šanghaj, Hongkong",
  ...
  recovery: {
    ...
    inputs: {
      ...
      hrvAvgLabel: "HRV (priemer / RMSSD) [ms]",
      rhrLabel: "Pokojový tep (RHR) [údery/min]",
      ...
      alcoholLabel: "Alkohol (objem a %) [ml]",
      noteLabel: "Poznámka",
    ...
    trends: {
      events: {
        alcohol: "Konzumácia alkoholu",
        food: "Ťažké jedlo neskoro",
        caffeine: "Kofeín neskoro",
      },
      common: {
      ...
      hrv: {
        title: "HRV",
        subtitle: "HRV a základné pásmo. Chýbajúce dni sú zvýraznené.",
        baselineMinus: "Základné pásmo −5 %",
        baselinePlus: "Základné pásmo +5 %",
        hrvLabel: "HRV Priemer",
        hrvMaxLabel: "HRV Max.",
        missingLabel: "Chýbajúci záznam",
        noRecord: "Bez záznamu",
      },
      rhr: {
        title: "RHR",
        subtitle: "RHR a základné pásmo. Chýbajúce dni sú zvýraznené.",
        baselineMinus: "Základné pásmo −5 %",
        baselinePlus: "Základné pásmo +5 %",
        rhrLabel: "RHR",
        missingLabel: "Chýbajúci záznam",
  ...
  limitations: {
    ...
    menstruationDesc:
      "AI automaticky upraví tréningovú záťaž a prioritizuje regeneráciu na najbližšie dni.",
    menstruationStarted:
      "Cyklus bol zaznamenaný. Nezabudni prispôsobiť plán nižšie.",
  ...
  healthLog: {
    ...
    widget: {
      title: "Obmedzenia a zranenia",
      tooltip:
        "Aktuálne zranenia, choroby, únava alebo fázy cyklu, ktoré ovplyvňujú tvoj plán.",
    ...
    symptoms: {
      ...
      chest_cough: "Dusený kašeľ (hrudník)",
      muscle_aches: "Bolesť svalov a kĺbov",
      nausea: "Nevoľnosť / Zvracanie",
      runny_nose: "Nádcha / Upchatý nos",
  ...
  sessions: {
    review: {
      ...
      injuryModal: {
        ...
        tooltipActive:
          "⚠️ Zranenie je uložené v profile. Pri generovaní nového plánu o ňom bude AI vedieť. Pre zrušenie ho zmažte zo zoznamu.",
      },
    },
    detail: {
