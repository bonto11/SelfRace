export const sk = {
  ...
  hints: {
    ...
    achilles: "Bolesť priamo na šľache, pri úpone na pätu alebo vyššie k lýtku?",
    ...
    hamstring: "Natiahnutie vzadu na stehne alebo bolesť vysoko tesne pod zadkom?",
    glute: "Hlboká bolesť v zadku (piriformis), vystreľuje do nohy, alebo svalovka?",
    hip: "Bolesť v bedrovom kĺbe z boku (burza) alebo vzadu?",
    psoas: "Bolesť hlboko v panve, pri dvíhaní kolena, alebo vyžaruje do chrbta?",
    groin: "Natiahnutý sval na vnútornej strane stehna (aduktor), alebo bolesť v triesle?",
    abdomen: "Bolí to na povrchu (brušné svaly, pruh) alebo skôr vo vnútri (pichanie v boku)?",
    ...
    arm_wrist: "Ide o zápästie, lakeť alebo predlaktie? (Časté pri bicyklovaní).",
    other: "Prosím, špecifikujte presné miesto a prejav bolesti do poznámky."
  }
},
  ...
  settings: {
    ...
    prefs: {
      ...
      timezones: {
        ...
        Atlantic_Canary: "(UTC±00:00) Kanárske ostrovy",
        Europe_Bratislava: "(UTC+01:00) Bratislava, Praha, Berlín",
        Europe_Vienna: "(UTC+01:00) Viedeň, Budapešť, Varšava",
        Europe_Paris: "(UTC+01:00) Paríž, Madrid, Rím",
        Europe_Athens: "(UTC+02:00) Atény, Bukurešť",
        Europe_Helsinki: "(UTC+02:00) Helsinki, Riga",
        Africa_Cairo: "(UTC+02:00) Káhira",
        Europe_Moscow: "(UTC+03:00) Moskva",
        Asia_Riyadh: "(UTC+03:00) Rijád",
        ...
        Asia_Dubai: "(UTC+04:00) Dubaj",
        Asia_Karachi: "(UTC+05:00) Karáčí",
        Asia_Kolkata: "(UTC+05:30) India (Kolkata)",
        Asia_Bangkok: "(UTC+07:00) Bangkok",
        Asia_Shanghai: "(UTC+08:00) Šanghaj, Hong Kong",
        Asia_Tokyo: "(UTC+09:00) Tokio, Soul",
  ...
  sessions: {
    review: {
      ...
      injuryModal: {
        ...
        tooltipActive: "⚠️ Zranenie je uložené v profile. Pri generovaní nového plánu o ňom bude AI vedieť. Pre zrušenie ho zmažte zo zoznamu."
      },
    },
    detail: {
