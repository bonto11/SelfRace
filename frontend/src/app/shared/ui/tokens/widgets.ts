...
export const WIDGET_ACCENT_BAR =
  `h-1.5 rounded-b-xl mt-3 bg-[${appColors.accentYellowDim}]`;
...
export const WIDGET_BULLET_DOT =
  `mt-[6px] h-1.5 w-1.5 rounded-full bg-[${appColors.textMuted}]`;
...
export const WIDGET_INFO_GRID_SM =
