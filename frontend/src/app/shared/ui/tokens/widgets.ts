...
export const WIDGET_HINT_STYLE: React.CSSProperties = {
...
export const WIDGET_ERROR_TEXT_STYLE: React.CSSProperties = {
...
export const WIDGET_ERROR_BLOCK_STYLE: React.CSSProperties = {
  color: appColors.statusError,
};

export const WIDGET_ERROR_SUB = "mt-1 text-xs opacity-80";
export const WIDGET_ERROR_SUB_STYLE: React.CSSProperties = {
  color: appColors.textMuted,
};
...
export const WIDGET_BULLET_DOT_STYLE: React.CSSProperties = {
...
export const WIDGET_ERROR_LINE_STYLE: React.CSSProperties = {
  color: appColors.statusError,
};
