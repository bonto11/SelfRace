  ...
  return (
    <div className="bg-black border-2 border-red-900/30 p-8 rounded-3xl shadow-2xl">
      ...
      <div className="mt-10 pt-8 border-t border-red-900/30">
        <button onClick={handleForceLogout} disabled={!!taskRunning} className="w-full bg-red-600 hover:bg-red-500 text-white font-black py-6 rounded-2xl uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(220,38,38,0.3)] transition-all active:scale-[0.98]">
