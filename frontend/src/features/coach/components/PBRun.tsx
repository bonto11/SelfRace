...
// ---- komponent -------------------------------------------------------------
export default function PBRun({ value, onChange, readOnly = false }: Props) {
  ...
  // Ak príde PBRun ako prop, premosť na UserBest
  useEffect(() => {
  ...
  return (
    <div className="bg-gray-800 rounded p-3 space-y-3">
      <h3 className="font-semibold text-lg">Personal Bests — Running</h3>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {rows.length === 0 ? (
              <tr>
                <td colSpan={readOnly ? 4 : 5} className="py-3 opacity-70">
                  No records yet.
                </td>
              </tr>
            ) : (
