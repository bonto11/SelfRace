...
export default function DetailRHR() {
  ...
  // iba vodorovná šírka podľa počtu dní
  ...
  const data: ChartData<"line", number[], string> = useMemo(() => {
    ...
    return {
      ...
      datasets: [
        ...
        { type: "line", label: "Resting HR", data: rhr, borderColor: "#f59e0b", backgroundColor: "#f59e0b", pointRadius: 3, borderWidth: 2, tension: 0.2, spanGaps: true, order: 3 },
      ],
    };
  ...
  return (
    <div className={`${CARD} relative`}>
      ...
      <div className="px-4 pt-4 pb-2 flex items-center justify-between gap-2">
        <h2 className="text-lg font-bold">Detail — Resting HR</h2>
