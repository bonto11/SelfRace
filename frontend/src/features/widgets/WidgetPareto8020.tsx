...
export default function WidgetPareto8020({
  ...
  // ber zo SESSION cez provider (ten má vlastnú cache pre widget)
  useEffect(() => {
    let alive = true;
    (async () => {
