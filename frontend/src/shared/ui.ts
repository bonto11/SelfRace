...
export const buttonClass =
  "rounded-md px-3 py-2 bg-primary text-[color:var(--on-primary)] hover:brightness-110 " +
  "disabled:opacity-60 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary";
