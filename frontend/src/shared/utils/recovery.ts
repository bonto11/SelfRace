...
/**
 * Rolling priemer s oknom dĺžky `windowDays`.
 * Pre deň D ráta baseline len z predchádzajúcich dní (D-1 .. D-window).
 */
...
/* ---------- ✅ Doplnené aliasy/obaly kvôli DetailRHR importom ---------- */

/** Alias, aby si mohol importovať `toISODate` – je to len `isoDate`. */
export const toISODate = isoDate;

/**
 * Pre pohodlie: vráti rolling baseline + ±5 % pásma.
 * Zodpovedá názvu, ktorý používaš v DetailRHR.
 */
